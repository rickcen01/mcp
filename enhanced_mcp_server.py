...
class EnhancedFeedbackMCP:
    ...
    def _register_tools(self):
        ...
        @self.app.tool()
        def enhanced_interactive_feedback(
        ...
        @self.app.tool()
        def enhanced_feedback_analytics(
            project_directory: str,
            days: int = 30,
            user_id: str = "default"
        ) -> Dict[str, Any]:
        ...
        @self.app.tool()
        def enhanced_feedback_template(
            template_name: str,
        ...
        @self.app.tool()
        def enhanced_execute_with_feedback(
            command: str,
            project_directory: str,
            ...
            try:
                if require_confirmation:
                    ...
                    confirmation_result = enhanced_interactive_feedback(
                ...
                if result.returncode != 0:
                    ...
                    error_feedback = enhanced_interactive_feedback(
                        project_directory=project_directory,
    ...
    def run(self):
        """启动服务器"""
        try:
            logger.info("启动增强型交互式反馈 MCP 服务器...")
            self.app.run()
        except Exception as e:
